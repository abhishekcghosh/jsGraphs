...
// test GRAPH
function testGraph() {
	// create  a few nodes, create a connection between them, and see what happens
	...
	//create a sample graph link
	vertices[0].attachVertex(vertices[1], true);
	vertices[0].attachVertex(vertices[2], true);

	vertices[1].attachVertex(vertices[2], true);
	vertices[1].attachVertex(vertices[3], true);
	vertices[1].attachVertex(vertices[4], true);	

	vertices[2].attachVertex(vertices[3], true);
	vertices[2].attachVertex(vertices[4], true);

	vertices[3].attachVertex(vertices[4], true);
	vertices[3].attachVertex(vertices[5], true);

	vertices[4].attachVertex(vertices[5], true);


	// display graph connections, 
	for (i = 0; i < 6; i++) {
		console.log("Vertex[" + i + "]: " + vertices[i].stringifyConnections());
	}
